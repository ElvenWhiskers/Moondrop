...
public class ColorerMenu extends AbstractContainerMenu {
    ...
    public ColorerMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.COLORER_MENU.get(), pContainerId);
        blockEntity = ((MDCauldronBlockEntity) entity);
        ...
        //input slot
        this.addSlot(new SlotItemHandler(this.blockEntity.itemHandler, 0, 13, 16));
        //result slot
        this.addSlot(new SlotItemHandler(this.blockEntity.itemHandler, 1, 142, 30));
        //fuel slot
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.MOONDROP_CAULDRON.get());
    }
